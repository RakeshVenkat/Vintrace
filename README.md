# vintrace-react-full-stack

- [vintrace-react-full-stack](#vintrace-react-full-stack)
...
This is a Wine tracing application that provides an interface to check the wine composition based on grouping criteria like: Year, Region, Variety.
The Front end of the application shall be written in [React](https://reactjs.org/).
The Back end services are written in [Node.js](https://nodejs.org/en/) and [Express](https://expressjs.com/) backend

## NOTE: 
Frontend code is STILL UNDER CONSTRUCTION
...
git clone https://github.com/RakeshVenkat/Vintrace.git
